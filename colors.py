...
def iprint(string):
    print(f'{ColorCodes.BRIGHT}{ColorCodes.GREEN}[{ColorCodes.CYAN}REX{ColorCodes.GREEN}]{ColorCodes.RESET}' + ' ' + f'{ColorCodes.WHITE}{ColorCodes.BRIGHT}{string}{ColorCodes.BRIGHT}{ColorCodes.RESET} ')

def oneline(string, sys, color=ColorCodes.GREEN):
    sys.stdout.write(f'\r{ColorCodes.RED}[{ColorCodes.CYAN}REX{ColorCodes.GREEN}]{ColorCodes.RESET}' + ' ' + f"{color}{ColorCodes.BRIGHT}{string}{ColorCodes.RESET}")
    sys.stdout.flush()
...
def rinput(color=ColorCodes.CYAN):
    r = input(f'{ColorCodes.BRIGHT}{ColorCodes.PURPLE}[{ColorCodes.BLUE}REX{ColorCodes.PURPLE}]{ColorCodes.CYAN} > {ColorCodes.RESET}')
    return r